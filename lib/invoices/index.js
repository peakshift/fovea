...
let { schema, draftSchema } = require('./schema')
 ...
 *
 * @param {Object} data - fields for creating new draft invoice
 *
 * @return {Promise}
 */
let createDraft = async (data) => {
  let invoice = Object.assign({}, data)

  let validationResult = validateBySchema(invoice, draftSchema)
